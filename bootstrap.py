...
class LavalinkBootstrap:
    ...
    def __init__(self):
        ...
        self.download_command = f"curl -L https://ci.fredboat.com/repository/download/Lavalink_Build/8735:id/Lavalink.jar?guest=1 -o Lavalink.jar" if self.use_dev_lavalink else f"curl -L https://github.com/Frederikam/Lavalink/releases/download/{self._version_number}/Lavalink.jar -O"
